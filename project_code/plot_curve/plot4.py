...
improvements = ['Vanilla', 'Double+Prioritized', 'Double+Dueling', 'Prioritized+Deuling', 'Double+Prioritized+Dueling']
...
plt.savefig("output/training_rewards4.pdf", format="pdf", bbox_inches="tight")
plt.savefig("output/training_rewards4.png", dpi=300, bbox_inches='tight')